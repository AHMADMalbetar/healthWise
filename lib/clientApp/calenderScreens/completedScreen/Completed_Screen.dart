        ...
        return Scaffold(
          body: ListView.builder(
            ...
            itemBuilder: (context, index) {
              int reversedIndex = Cubit.cardCompletedList.length - 1 - index;
              return Cubit.cardCompletedList[reversedIndex];
            },
            itemCount: Cubit.cardCompletedList.length,
          ),
        );
      },
    );
