...
import '../../allCubites/doctorCubits/dateCubit/date_cubit.dart';
import '../../classes/doctorClass.dart';
import '../orderTheDoctor/orderTheDoctor.dart';

class doctorProfile extends StatelessWidget {
  doctorProfile(this.docName,
      this.docWork,
      this.docRate,
      this.docLocation,
      this.docImage,);
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<DateCubit, DateState>(
        ...
        builder: (context, state) {
          var Cubit = DateCubit.get(context);
          return Scaffold(
            appBar: AppBar(
              elevation: 0,
              leading: IconButton(
                            ...
                            onPressed: () {
                              if(index1==-1||index2==-1){
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => orderTheDoctor(
                                        docName,
                                        docWork,
                                        docRate,
                                        docLocation,
